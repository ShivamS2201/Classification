...
#The mkdir doesnot work for paths which haven't been intiliased.
...
# YOUR CODE STARTS HERE
    ...
    for unitData in os.listdir(SOURCE):
        ...
        if (os.path.getsize(data) > 0):
            ...
            print('Skipped ' + unitData+ 'Length is zero')
...
model.compile(optimizer=RMSprop(lr=0.001), loss='binary_crossentropy', metrics=['acc'])  #rmsprop gives choice for learning rate
...
# TRAIN GENERATOR.
#will be getting 100 batches of size 10
